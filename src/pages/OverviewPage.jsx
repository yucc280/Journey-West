  ...
  return (
    <div className="overview-page">
      ...
      <section
        ...
        style={{ backgroundImage: `url(${baseUrl}media/west-silhouette.jpg)` }}
      >
        <div className="hero-mask">
          <div className="hero-content">
            ...
            <p className="hero-description">
              “踏过坎坷成大道，斗罢艰险又出发。” 结合数据可视化与现代 AI
              大模型，全方位解构古典名著《西游记》的叙事魅力。
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="interactive-grid">
        <div className="visualizer-wrapper">
          <AudioVisualizer audioSrc={`${baseUrl}media/music.mp3`} />
        </div>

        <div className="art-intro-wrapper">
          <div className="art-card">
            <img
              src={`${baseUrl}media/west-characters.jpg`}
              alt="西游师徒工笔重彩"
              className="art-img"
            />
            <div className="art-content">
              <h3>典籍多维探微</h3>
              <p>
                这是一个面向文学文本探索的交互式可视分析系统，从
                <strong>地理</strong>、<strong>难关</strong>、
                <strong>人物关系</strong>与<strong>情感词频</strong>
                四大维度入手，打破传统阅读方式，带你以全新的视角审视《西游记》这部东方奇幻史诗。
              </p>
